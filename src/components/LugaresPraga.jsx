      ...
      <div className={claseContainer}>
        ...
        {linkCeremonia && linkCeremonia.trim() !== "" && (
          <div className="flex flex-col items-center gap-3 max-w-xs">
            ...
            <h3 className="text-xl font-semibold tracking-wider">CEREMONIA CIVIL</h3>
          ...
          <div className="flex flex-col items-center gap-3 max-w-xs mt-10 md:mt-0">
            <div style={{ width: 120, height: 120 }}>
              <Lottie
                loop
                play
            ...
            <p className="font-light">
              {linkCivil && linkCivil.trim() !== ""
                ...
                : <>El festejo se realizará en <strong>Pérez Galdos 3064, San Fernando</strong> el <strong>15 de noviembre</strong> a las <strong>{horaFiesta}</strong>.</>}
            </p>
            <a
              href={linkFiesta}
              target="_blank"
